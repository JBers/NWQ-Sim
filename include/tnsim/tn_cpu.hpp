...
namespace NWQSim
{
    ...
    public:
        ...
        {
            throw std::runtime_error("TN_CPU::set_initial not implemented");
        }

        void dump_res_state(std::string /*outpath*/) override
        {
            throw std::runtime_error("TN_CPU::dump_res_state not implemented");
        }
        ...
        {
            throw std::runtime_error("TN_CPU::get_results not implemented");
        }

        IdxType measure(IdxType /*qubit*/) override
        {
            throw std::runtime_error("TN_CPU::measure not implemented");
        }
        ...
        {
            throw std::runtime_error("TN_CPU::get_real not implemented");
        }

        ValType* get_imag() const override
        {
            throw std::runtime_error("TN_CPU::get_imag not implemented");
        }

        ValType get_exp_z() override
        {
            throw std::runtime_error("TN_CPU::get_exp_z() not implemented");
        }

        ValType get_exp_z(const std::vector<size_t>& /*in_bits*/) override
        {
            throw std::runtime_error("TN_CPU::get_exp_z(bits) not implemented");
        }

        void print_res_state() override
        {
            throw std::runtime_error("TN_CPU::print_res_state not implemented");
        }
